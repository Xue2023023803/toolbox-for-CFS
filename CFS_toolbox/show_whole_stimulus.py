...
def present_noise_and_stimuli(win, target_sequence, noise_sequence, target_position, noise_position, noise_duration, noise_frequency,bloder,fusion_box_image_path):
    # 创建时钟来记录时间
